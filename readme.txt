Это бот для поиска отеля на aiogram.
Использует API Hotels.com
...
Развитие:
Добавить многоязычность и хранить язык в частной конфигурации пользователя.
Чтобы не утомлять пользователя вводом данных о поездке (количество взрослых, детей),
их тоже можно хранить в конфигураторе. Даты заезда и отъезда можно брать от текущей дата +1 неделя,
как сейчас сделано в подсказке выбора дат.
